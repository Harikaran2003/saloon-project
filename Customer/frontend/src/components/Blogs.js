...
const trendingMaleHairstyles = [
  { name: "Buzz Cut", image: require('../img/Buzz_Cut.jpg') },
  { name: "Crew Cut", image: require('../img/Crew_Cut.jpeg') },
  { name: "Fade Cut", image: require('../img/Fade_Cut.jpg') },
  { name: "Pompadour", image: require('../img/Pompadour.jpg') },
  { name: "Quiff", image: require('../img/Quiff.jpg') },
  { name: "Caesar Cut", image: require('../img/Caesar_Cut.jpg') },
  { name: "Textured Crop", image: require('../img/Textured_Crop.jpg') },
  { name: "Side Part", image: require('../img/Side_Part.jpeg') },
];
